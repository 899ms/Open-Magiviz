        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside mb-4 space-y-2">
                <li>{isZh ? '提供流畅的AI视频创作导航体验' : 'Providing smooth AI video creation navigation experience'}</li>
                <li>{isZh ? '记住您的视频创作偏好设置（如分辨率、时长、风格）' : 'Remembering your video creation preferences (such as resolution, duration, style)'}</li>
                <li>{isZh ? '减少重复输入创作参数和描述信息' : 'Reducing repetitive input of creation parameters and description information'}</li>
                <li>{isZh ? '根据您的创作历史提供个性化的视频风格推荐' : 'Providing personalized video style recommendations based on your creation history'}</li>
              </ul>
              ...
              <ul className="list-disc list-inside mb-4 space-y-2">
                <li>{isZh ? '分析用户视频创作行为模式和偏好' : 'Analyzing user video creation behavior patterns and preferences'}</li>
                <li>{isZh ? '识别和修复AI视频生成的技术问题' : 'Identifying and fixing technical issues with AI video generation'}</li>
                <li>{isZh ? '优化视频生成速度和质量性能' : 'Optimizing video generation speed and quality performance'}</li>
                <li>{isZh ? '开发新的视频创作功能和AI模型' : 'Developing new video creation features and AI models'}</li>
              </ul>
            </section>
