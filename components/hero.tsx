              ...
              >
                ...
                <div className="relative w-full aspect-square rounded-lg bg-muted overflow-hidden">
                  <img
                    ...
                    src="https://img.magiviz.com/home/char_tanjiro-1773555549691.png"
                ...
                <div className="grid grid-cols-1 gap-1.5 md:gap-2">
                  <div className="aspect-video bg-muted rounded-md overflow-hidden">
                    <img
                      ...
                      src="https://img.magiviz.com/home/1773556481535-96bgmfqehgd.png"
                      referrerPolicy="no-referrer"
                    />
                  </div>
                  <div className="aspect-video bg-muted rounded-md overflow-hidden">
                    <img
                      alt="Grid 2"
                      className="w-full h-full object-cover opacity-80 mix-blend-multiply dark:mix-blend-normal"
                      src="https://img.magiviz.com/home/1773556472079-wopkkww8lal.png"
                      referrerPolicy="no-referrer"
                    />
                  </div>
                </div>
