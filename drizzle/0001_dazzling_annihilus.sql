...
CREATE TABLE "ai_generation_tasks" (
	...
	"createdAt" timestamp DEFAULT now(),
	"updatedAt" timestamp DEFAULT now(),
	CONSTRAINT "ai_generation_tasks_taskId_unique" UNIQUE("taskId")
);
--> statement-breakpoint
CREATE TABLE "project_data" (
	...
	"scriptScenes" jsonb,
	"characterData" jsonb,
	"storyboardData" jsonb,
	"sceneVideoData" jsonb,
	"finalVideoUrl" text,
	"finalVideoThumbnail" text,
	"finalVideoDuration" integer,
	"finalVideoSize" text,
...
ALTER TABLE "ai_generation_tasks" ADD CONSTRAINT "ai_generation_tasks_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "project_data" ADD CONSTRAINT "project_data_projectId_video_projects_id_fk" FOREIGN KEY ("projectId") REFERENCES "public"."video_projects"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "video_projects" ADD CONSTRAINT "video_projects_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "ai_task_task_id_idx" ON "ai_generation_tasks" USING btree ("taskId");--> statement-breakpoint
CREATE INDEX "ai_task_user_id_idx" ON "ai_generation_tasks" USING btree ("userId");--> statement-breakpoint
CREATE INDEX "ai_task_status_idx" ON "ai_generation_tasks" USING btree ("status");--> statement-breakpoint
CREATE INDEX "pd_project_id_idx" ON "project_data" USING btree ("projectId");--> statement-breakpoint
CREATE INDEX "pd_version_idx" ON "project_data" USING btree ("version");--> statement-breakpoint
CREATE INDEX "vp_user_id_idx" ON "video_projects" USING btree ("userId");--> statement-breakpoint
CREATE INDEX "vp_status_idx" ON "video_projects" USING btree ("status");--> statement-breakpoint
CREATE INDEX "vp_created_at_idx" ON "video_projects" USING btree ("createdAt");--> statement-breakpoint
